...
describe('printTheme', () => {
  ...
  it('recognizes known theme ids', () => {
    ...
    expect(isPrintThemeId('academic')).toBe(true)
    expect(isPrintThemeId('memo')).toBe(true)
    expect(isPrintThemeId('resume')).toBe(true)
    expect(isPrintThemeId('blog')).toBe(true)
